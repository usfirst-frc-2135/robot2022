...
Climber::Climber()
{
    ...
    frc::SmartDashboard::PutBoolean("CL14_FailedToInitialize", true);
    frc::SmartDashboard::PutBoolean("CL15_FailedToInitialize", true);
    while (!(m_talonValidCL14 = frc2135::TalonUtils::TalonCheck(m_motorCL14, "CL", "CL14")))
    {
        spdlog::warn("CL Waiting for CL14 to be valid");
        frc::SmartDashboard::PutBoolean("CL14_FailedToInitialize", false);
    }
    while (!(m_talonValidCL15 = frc2135::TalonUtils::TalonCheck(m_motorCL15, "CL", "CL15")))
    {
        spdlog::warn("CL Waiting for CL15 to be valid");
        frc::SmartDashboard::PutBoolean("CL15_FailedToInitialize", false);
    }
...
void Climber::Periodic()
{
    ...
    m_hasResetOccurredCL14 += (m_motorCL14.HasResetOccurred()) ? 1 : 0;
    m_hasResetOccurredCL15 += (m_motorCL15.HasResetOccurred()) ? 1 : 0;
    frc::SmartDashboard::PutNumber("CL_HasResetOccurredCL14", m_hasResetOccurredCL14);
    frc::SmartDashboard::PutNumber("CL_HasResetOccurredCL15", m_hasResetOccurredCL15);

    bool IsFollowerModeCL15 = (m_motorCL15.GetControlMode() == ControlMode::Follower);
    frc::SmartDashboard::PutBoolean("CL_IsFollowerModeCL15", IsFollowerModeCL15);

    if (!IsFollowerModeCL15)
    ...
    {
        m_resetCountCL14 += 1;
        frc::SmartDashboard::PutNumber("HL_Resets_CL14", m_resetCountCL14);
    }
    if (m_motorCL15.HasResetOccurred())
    {
        m_resetCountCL15 += 1;
        frc::SmartDashboard::PutNumber("HL_Resets_CL15", m_resetCountCL15);
    }
}
