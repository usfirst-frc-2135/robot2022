...
void Drivetrain::SimulationPeriodic()
{
    ...
    // add gyro2 simulation get angle
}
...
void Drivetrain::Initialize(void)
{
    ...
    ResetOdometry({ { 0_m, 0_m }, m_gyro2.GetRotation2d() });
    m_driveSim.SetPose(m_odometry.GetPose());
    m_driveSim.SetPose(m_odometry2.GetPose());
    m_field.SetRobotPose(m_odometry.GetPose());
    m_field.SetRobotPose(m_odometry2.GetPose());
}
...
void Drivetrain::UpdateOdometry(void)
{
    ...
    m_odometry2.Update(frc::Rotation2d(GetHeadingAngle()), m_distanceLeft, m_distanceRight);
...
void Drivetrain::ResetOdometry(frc::Pose2d pose)
{
    ...
    m_odometry2.ResetPosition(pose, GetHeadingAngle());
}
