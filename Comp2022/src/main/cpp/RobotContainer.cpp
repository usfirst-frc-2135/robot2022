        ...
        &m_drivetrain)
{
    ...
    frc::SmartDashboard::PutData(
        "Auto 1 Ball 2 Opp Left",
        new Auto1Ball2OppLeft(&m_drivetrain, &m_intake, &m_floorConv, &m_vertConv, &m_shooter));
    frc::SmartDashboard::PutData(
        "Auto 1 Ball 1 Opp Right",
        new Auto1Ball1OppRight(&m_drivetrain, &m_intake, &m_floorConv, &m_vertConv, &m_shooter));
