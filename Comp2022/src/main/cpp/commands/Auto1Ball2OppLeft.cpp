    ...
    Shooter *shooter)
{
    ...
    config->GetValueAsString("Auto1Ball2OppLeft_path2", m_pathname2, "shootingPosToBall");
    config->GetValueAsString("Auto1Ball2OppLeft_path3", m_pathname3, "ballToShootingPos");
    config->GetValueAsString("Auto1Ball2OppLeft_path4", m_pathname4, "shootingPosToLeftBall");
    config->GetValueAsString("Auto1Ball2OppLeft_path5", m_pathname5, "leftBallToLeftShootingPos");
    ...
    spdlog::info("Auto1Ball2OppLeft pathname 5 {}", m_pathname5.c_str());
