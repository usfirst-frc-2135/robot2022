    ...
    Shooter *shooter)
{
    ...
    config->GetValueAsString("Auto1Ball1OppRight_path2", m_pathname2, "shootingPosToBall");
    config->GetValueAsString("Auto1Ball1OppRight_path3", m_pathname3, "ballToShootingPos");
    config->GetValueAsString("Auto1Ball1OppRight_path4", m_pathname4, "shootingPosToLeftBall");
    config->GetValueAsString("Auto1Ball1OppRight_path5", m_pathname5, "leftBallToLeftShootingPos");
    spdlog::info("Auto1Ball1OppRight pathname 1 {}", m_pathname1.c_str());
    spdlog::info("Auto1Ball1OppRight pathname 2 {}", m_pathname2.c_str());
    spdlog::info("Auto1Ball1OppRight pathname 3 {}", m_pathname3.c_str());
    spdlog::info("Auto1Ball1OppRight pathname 4 {}", m_pathname4.c_str());
    spdlog::info("Auto1Ball1OppRight pathname 5 {}", m_pathname5.c_str());
