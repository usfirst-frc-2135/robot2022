...
ClimberClimbL2RotateL3::ClimberClimbL2RotateL3(Climber *climber)
{
    // Use AddRequirements() here to declare subsystem dependencies
    // eg. AddRequirements(m_Subsystem);
    SetName("ClimberClimbL2RotateL3");
    ...
    AddCommands(ClimberClimbToL2(climber), ClimberRotateToL3(climber));
}

bool ClimberClimbL2RotateL3::RunsWhenDisabled() const
{
