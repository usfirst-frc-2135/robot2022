...
ClimberRotateToL3::ClimberRotateToL3(Climber *climber)
{
    ...
    // Climber raises to 24 inches
    // Gate hook activated (extended)

    AddCommands(ClimberMoveHeight(Climber::ROTATE_L3_HEIGHT, climber), ClimberSetGateHook(true));
}
